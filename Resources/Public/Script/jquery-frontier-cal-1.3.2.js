...
(function($) {
		...
		*/
		...
		this.do_init = function(){
			...
			for(var dayIndex = 0; dayIndex < Calendar.dayNames.length; dayIndex++){
				...
				//TODO par rapport au date Picker
				if(jQuery.datepicker._defaults.dayNamesMin[dayIndex]) {
					calHeaderCell.setHtml("&nbsp;"+jQuery.datepicker._defaults.dayNamesMin[dayIndex]);
				} else {
					calHeaderCell.setHtml("&nbsp;"+Calendar.dayNames[dayIndex]);
				}
				calHeader.appendCalendarHeaderCell(calHeaderCell);
				if(dayIndex == 0){
					calHeaderCell.addClass("JFrontierCal-Header-Cell-First");
				}
				if(dayIndex == 6){
			...
			for(var dayIndex = 0; dayIndex < Calendar.dayNames.length; dayIndex++){
				...
				if(dayIndex == 0){
					calDayCell.addClass("JFrontierCal-Day-Cell-First");
					calWeekHeaderCellObj.addClass("JFrontierCal-Week-Header-Cell-First");
				}
				if(dayIndex == 6){
	...
	$.fn.jFrontierCal = function(attr,options) {
        ...
        return this.each(function() {
			...
			calElm.thisCalOpts = thisCalOpts;
			// create plugin
	...
	var jFrontierCalPlugin = function(
		...
		this.init = function(){
			...
			//var dtNow = new Date()
			//TODO LME passage de l'option date
			var dtNow = calElm.thisCalOpts.date;
